...
async def start_command(message: types.Message):
    ...
    welcome_text = (
        "<b>Welcome to <a href='https://github.com/Johnny-Taake/TGAntiSpamBot'>TG AntiSpam Bot</a>!</b>\n\n"
        ...
        "• /metrics - Check runtime metrics (admin only)\n"
        "• /test_ai - Test AI service (admin only)\n"
    )
